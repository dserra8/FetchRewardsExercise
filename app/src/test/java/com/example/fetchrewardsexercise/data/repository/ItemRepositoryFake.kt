...
/**
 * Creating a fake repository because I don't need to call the real api to unit test
 * my data logic, I just need to simulate the real thing.
 */
class ItemRepositoryFake : ItemRepositoryInterface {
